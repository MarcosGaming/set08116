...
bool load_content() {
  ...
  vector<vec3> positions{
	  ...
	  vec3(0.0f,0.0f,0.0f),vec3(0.0f,0.0f,1.0f),vec3(1.0f,0.0f,1.0f),vec3(1.0f,0.0f,0.0f),
	  vec3(0.0f,1.0f,0.0f),vec3(0.0f,1.0f,1.0f),vec3(1.0f,1.0f,1.0f),vec3(1.0f,1.0f,0.0f)
      // *********************************
  };
  // Colours
  vector<vec4> colours;
